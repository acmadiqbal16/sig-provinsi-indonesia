...
<body>
        <nav class="navbar navbar-expand-lg navbar-dark" style="background-color: #004085;">
         ...
         <div class="container">
                <h1>Jumlah Guru di Provinsi DKI Jakarta</h1>
       ...
       geojson = L.geoJson(geoJson, {style: style,  onEachFeature: onEachFeature}).addTo(map);
        ...
        var info = L.control();
            ...
            info.update = function (props) {
                this._div.innerHTML = '<h4>Jumlah Guru di Provinsi DKI Jakarta</h4>' +  (props ?
                    '<b>' + props.name + '</b><br />' + props.jumlah_guru.toLocaleString('id-ID') + 'Jiwa'
                    : 'Pilih Wilayah');
            };
            ...
            var legend = L.control({position: 'bottomright'});
                ...
                legend.onAdd = function (map) {
                    ...
                    var div = L.DomUtil.create('div', 'info legend'),
                        grades = [0, 300, 8000, 10000, 15000 , 18000 , 25000],
                        labels = [];
