        ...
        return $form
            ->schema([
                ...
                Forms\Components\TextInput::make('populasi')
                    ->required()
                    ->numeric(),
                Forms\Components\TextInput::make('kepadatan')
                    ->required()
                    ->numeric(),
                Forms\Components\TextInput::make('jumlah_suku')
                    ->required()
                    ->numeric(),
            ]);
    }
        ...
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('populasi')
                    ->numeric()
                    ->sortable(),
                Tables\Columns\TextColumn::make('kepadatan')
                    ->numeric()
                    ->sortable(),
                Tables\Columns\TextColumn::make('jumlah_suku')
                    ->numeric()
                    ->sortable(),
